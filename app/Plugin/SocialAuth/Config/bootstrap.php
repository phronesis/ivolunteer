...
Configure::write('HybridAuth.defaultProviders',$defaultProviders);
define('HYBRID_AUTH_LIB_PATH',APP.'Plugin'.DS.'SocialAuth'.DS.'Lib'.DS.'Hybrid');
define('BASE_URL','http://baseapp.loc/social_auth/set_up/index');
?>
