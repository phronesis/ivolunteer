...
<div id="page-container" class="row-fluid">
	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
										<li><?php echo $this->Html->link(__('List Project Statuses'), array('action' => 'index')); ?></li>
	...
	<div id="page-content" class="span9">
		...
		<div class="projectStatuses form">
			...
			<?php echo $this->Form->create('ProjectStatus', array('inputDefaults' => array('label' => false), 'class' => 'form form-horizontal')); ?>
				<fieldset>
					<h2><?php echo __('Add Project Status'); ?></h2>
