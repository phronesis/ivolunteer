...
<div id="page-container" class="row-fluid">
	...
	<div id="sidebar" class="span3">
		...
		<div class="actions">
			...
			<ul class="nav nav-list bs-docs-sidenav">
										<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProjectImage.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProjectImage.id'))); ?></li>
										<li><?php echo $this->Html->link(__('List Project Images'), array('action' => 'index')); ?></li>
	...
	<div id="page-content" class="span9">
		...
		<div class="projectImages form">
			...
			<?php echo $this->Form->create('ProjectImage', array('inputDefaults' => array('label' => false), 'class' => 'form form-horizontal')); ?>
				<fieldset>
					<h2><?php echo __('Edit Project Image'); ?></h2>
