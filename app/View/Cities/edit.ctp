...
<div id="page-container" class="row-fluid">
	...
	<div id="page-content" class="span9">
		...
		<div class="cities form">
			...
			<?php echo $this->Form->create('City', array('inputDefaults' => array('label' => false), 'class' => 'form form-horizontal')); ?>
				<fieldset>
					<h2><?php echo __('Edit City'); ?></h2>
...
<div class="control-group">
	<?php echo $this->Form->label('state_id', 'state_id', array('class' => 'control-label'));?>
	<div class="controls">
